...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-lg-4 text-center text-lg-end">
          <div class="d-inline-flex align-items-center" style="height: 45px">
            <?php if (isset($_SESSION['user_id'])): ?>
              <a href="#" class="me-3 text-light"><i class="fa fa-user me-2"></i>Welcome, <?php echo $_SESSION['user_name']; ?></a>
              <a href="logout.php" class="me-3 text-light"><i class="fa fa-sign-out-alt me-2"></i>Logout</a>
            <?php else: ?>
              <a href="register.html" class="me-3 text-light"><i class="fa fa-user me-2"></i>Register</a>
              <a href="login.html" class="me-3 text-light"><i class="fa fa-sign-in-alt me-2"></i>Login</a>
            <?php endif; ?>
          </div>
        </div>
      </div>
    ...
    <div class="container-fluid position-relative p-0">
      ...
      >
        <a href="" class="navbar-brand p-0">
          <h1 class="m-0">
            <i class="fa fa-map-marker-alt me-3"></i>Ceylon Buddy
          </h1>
          ...
          <ul class="nav nav-pills d-inline-flex justify-content-center mb-5">
            ...
            <li class="nav-item">
              <a
                ...
                href="#GalleryTab-2"
              >
                <span class="text-dark" style="width: 150px">Sigiriya</span>
              </a>
            </li>
            <li class="nav-item">
              <a
                ...
                href="#GalleryTab-3"
              >
                <span class="text-dark" style="width: 150px">Galle Fort</span>
              </a>
            </li>
            <li class="nav-item">
              <a
            ...
            <li class="nav-item">
              <a
                ...
                href="#GalleryTab-4"
              >
                <span class="text-dark" style="width: 150px">Ella</span>
              </a>
            </li>
            <li class="nav-item">
              <a
                ...
                href="#GalleryTab-5"
              >
                <span class="text-dark" style="width: 150px">Down South</span>
              </a>
            </li>
          </ul>
              ...
              <div class="row g-2">
                  ...
                  <div class="gallery-item h-100">
                    ...
                    <div class="gallery-content">
                      <div class="gallery-info">
                        <h5 class="text-white text-uppercase mb-2">Sigiriya</h5>
                        <a
                          href="/places/sigiriya/sigiriya.html"
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                  <div class="gallery-item h-100">
                    ...
                    <div class="gallery-content">
                      <div class="gallery-info">
                        <h5 class="text-white text-uppercase mb-2">Ella</h5>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                  <div class="gallery-item h-100">
                    ...
                    <div class="gallery-content">
                      <div class="gallery-info">
                        <h5 class="text-white text-uppercase mb-2">Down South</h5>
                        <a href="#" class="btn-hover text-white"
                          >View All Place <i class="fa fa-arrow-right ms-2"></i
                        ></a>
                      </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-2">
                  <div class="gallery-item h-100">
                    ...
                    <div class="gallery-content">
                      <div class="gallery-info">
                        <h5 class="text-white text-uppercase mb-2">Galle Fort</h5>
                        <a href="#" class="btn-hover text-white"
                          >View All Place <i class="fa fa-arrow-right ms-2"></i
                        ></a>
                      </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                  <div class="gallery-item h-100">
                    ...
                    <div class="gallery-content">
                      <div class="gallery-info">
                        <h5 class="text-white text-uppercase mb-2">Colombo</h5>
                        <a href="#" class="btn-hover text-white"
                          >View All Place <i class="fa fa-arrow-right ms-2"></i
                        ></a>
                      </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3 col-xl-2">
                  <div class="gallery-item h-100">
                    ...
                    <div class="gallery-content">
                      <div class="gallery-info">
                        <h5 class="text-white text-uppercase mb-2">Pasikuda</h5>
                        <a href="#" class="btn-hover text-white"
                          >View All Place <i class="fa fa-arrow-right ms-2"></i
                        ></a>
                      </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                  <div class="gallery-item h-100">
                    ...
                    <div class="gallery-content">
                      <div class="gallery-info">
                        <h5 class="text-white text-uppercase mb-2">Wilpaththu</h5>
                        <a href="#" class="btn-hover text-white"
                          >View All Place <i class="fa fa-arrow-right ms-2"></i
                        ></a>
                      </div>
              ...
              <div class="row g-2">
                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                  <div class="gallery-item h-100">
                    ...
                    <div class="gallery-content">
                      <div class="gallery-info">
                        <h5 class="text-white text-uppercase mb-2">Negambo</h5>
                        <a href="#" class="btn-hover text-white"
                          >View All Place <i class="fa fa-arrow-right ms-2"></i
                        ></a>
                      </div>
      ...
      <div class="container py-5">
        <div class="row g-5 align-items-center">
          ...
          >
            ...
            <p class="mb-4">
              At Ceylon Buddy, we are passionate about showcasing the
              breathtaking beauty, rich heritage, and warm hospitality of Sri
              Lanka. Our mission is to inspire travelers from around the world
              to explore this tropical paradise, where every journey is a story
              waiting to be told. From sun-kissed beaches and misty mountains to
              ancient ruins and vibrant festivals, Sri Lanka is a land of
              wonders. Whether you seek adventure, cultural immersion,
              relaxation, or wildlife encounters, our platform is designed to
              help you discover the best experiences the island has to offer. We
              believe in sustainable and responsible tourism, ensuring that
              every visit contributes to preserving Sri Lanka’s natural beauty,
              empowering local communities, and protecting its rich history.
              Through carefully curated content, expert travel insights, and
              exclusive recommendations, we make it easy for you to plan your
              dream getaway.
            </p>
            <p class="mb-4" style="color: black; font-size: large;" > <b>Join us in exploring Sri Lanka – where every sunset is magical,
                every meal is a feast, and every journey leaves a lasting
                impression. Your adventure starts here!</b>
            </p>
        ...
        <div class="container py-5">
          ...
          <div class="row g-4">
            ...
            <div class="col-lg-6">
              <div class="row g-4">
                ...
                <div class="col-12">
                  <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                    <div class="service-content text-end">
                      <h5 class="mb-4">Customized Travel Packages</h5>
                      <p class="mb-0">
                        Whether you seek adventure, culture, nature, or luxury, we design tailored experiences that suit your interests and budget.
                      </p>
                    </div>
                ...
                <div class="col-12">
                  <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                    <div class="service-content text-end">
                      <h5 class="mb-4">Hotel & Accommodation Bookings</h5>
                      <p class="mb-0">
                        From beachfront resorts to cozy boutique stays, we help you find the perfect place to relax.
                      </p>
                    </div>
                    <div class="service-icon p-4">
                ...
                <div class="col-12">
                  <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                    <div class="service-content text-end">
                      <h5 class="mb-4">Tour & Activity Planning</h5>
                      <p class="mb-0">
                        Explore Sri Lanka's iconic landmarks, wildlife safaris, scenic hikes, and hidden gems with expertly curated itineraries.
                      </p>
                    </div>
                    <div class="service-icon p-4">
              ...
              <div class="row g-4">
                ...
                <div class="col-12">
                  <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                    ...
                    <div class="service-content">
                      <h5 class="mb-4">Transportation & Transfers</h5>
                      <p class="mb-0">
                        Hassle-free airport pickups, private drivers, and comfortable transport options to get you around.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                    ...
                    <div class="service-content">
                      <h5 class="mb-4">Local Expertise & Travel Guidance</h5>
                      <p class="mb-0">
                        Insider tips, travel advice, and recommendations to ensure an authentic and memorable journey.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                    <div class="service-icon p-4">
                      <i class="fa fa-leaf fa-4x text-primary"></i>
                    </div>
                    <div class="service-content">
                      <h5 class="mb-4">Sustainable & Responsible Tourism</h5>
                      <p class="mb-0">
                        We promote eco-friendly travel, support local communities, and encourage ethical tourism practices.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-12 d-flex justify-content-center mt-4">
              <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4" style="max-width: 800px;">
                <div class="service-icon p-4">
                  <i class="fa fa-user fa-4x text-primary"></i>
                </div>
                <div class="service-content">
                  <h5 class="mb-4">At Ceylon Buddy, we go beyond just planning trips</h5>
                  <p class="mb-0">
                    We create unforgettable experiences that connect you with the beauty, culture, and warmth of Sri Lanka. Let us be your trusted travel companion in discovering this island paradise!
                  </p>
                </div>
              </div>
            </div>
    ...
    <!-- <div class="container-fluid destination py-5">
            <div class="container py-5">
                ...
                <div class="tab-class text-center">
                    <ul class="nav nav-pills d-inline-flex justify-content-center mb-5">
                        <li class="nav-item">
                            <a class="d-flex mx-3 py-2 border border-primary bg-light rounded-pill active" data-bs-toggle="pill" href="blog.html">
                                <span class="text-dark" style="width: 150px;">All</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="d-flex py-2 mx-3 border border-primary bg-light rounded-pill" data-bs-toggle="pill" href="blog.html">
    ...
    <div class="container-fluid guide py-5">
      <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px">
          ...
          <h1 class="mb-0">Meet Our Guider</h1>
        </div>
            ...
            <div class="guide-item text-center">
              ...
              <div class="guide-title text-center rounded-bottom p-4">
                <div class="guide-title-inner">
                  <h4 class="mt-3">Ranil Sampath Appuhamy</h4>
    ...
    <div class="container-fluid booking py-5" id="booking">
      <div class="container py-5">
        <div class="row g-5 align-items-center">
          ...
          <div class="col-lg-6">
            <h1 class="text-white mb-3">Book A Tour Guider</h1>
            <p class="text-white mb-4">
              Get <span class="text-warning">50% Off</span> On Your First
              Adventure Trip With Ceylon Buddy. Get More Deal Offers Here.
            </p>
            <form>
              <div class="row g-3">
                <div class="col-md-6">
    ...
    <div class="container-fluid testimonial py-5">
      <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px">
          ...
          <h1 class="mb-0">With Our Clients</h1>
        </div>
        <div class="testimonial-carousel owl-carousel">
          <div class="testimonial-item text-center rounded pb-4">
            <div class="testimonial-img p-1">
              <img src="Testimonial/withkandy.jpg" alt="Image" />
            </div>
            <div class="testimonial-content">
              <h5 class="mb-0">Kandy</h5>
            </div>
          </div>
    ...
    <!-- Feedback Start -->
    <div class="container-fluid feedback py-5">
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            <h5 class="section-title px-3">Feedback</h5>
            <h1 class="mb-4">We Value Your Feedback</h1>
            <p class="mb-0">Please share your thoughts and experiences with us. Your feedback helps us improve our services and provide you with the best travel experiences.</p>
        </div>
        <div class="row g-4 justify-content-center">
            <div class="col-lg-8">
                <form>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-white border-0" id="feedbackName" placeholder="Your Name">
                                <label for="feedbackName">Your Name</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="email" class="form-control bg-white border-0" id="feedbackEmail" placeholder="Your Email">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <select class="form-select bg-white border-0" id="feedbackRating">
                                    <option selected disabled>Rate Us</option>
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control bg-white border-0" placeholder="Your Feedback" id="feedbackMessage" style="height: 150px"></textarea>
                                <label for="feedbackMessage">Your Feedback</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary text-white w-100 py-3" type="submit">Submit Feedback</button>
                        </div>
                    </div>
                </form>
            </div>
      ...
      <div class="container">
        <div class="row g-4 align-items-center">
          <div class="col-md-6 text-center text-md-end mb-md-0">
            ...
            ><a class="text-white" href="#">Your Site Name</a>, All right
            reserved.
          </div>
